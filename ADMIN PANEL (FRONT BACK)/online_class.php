...
if (isset($_POST['addClass'])) {
    ...
    $stmt = $pdo->prepare("INSERT INTO onlineclassregistrations (name, email, subject) VALUES (?, ?, ?)");
...
if (isset($_POST['updateClass'])) {
    ...
    $stmt = $pdo->prepare("UPDATE onlineclassregistrations SET name = ?, email = ?, subject = ? WHERE id = ?");
...
if (isset($_GET['delete_id'])) {
    $id = $_GET['delete_id'];
    $stmt = $pdo->prepare("DELETE FROM onlineclassregistrations WHERE id = ?");
    $stmt->execute([$id]);
    header("Location: online_class.php");
}

// Fetch all online classes
$stmt = $pdo->query("SELECT * FROM onlineclassregistrations");
...
<head>
    ...
    <title>Institute Admin Panel - Online Class</title>
...
<body>
            ...
            <tbody>
                <?php foreach ($classes as $class): ?>
                    <tr>
                        ...
                        <td>
                        <button onclick="openEditModal('<?= $class['id'] ?>', '<?= $class['name'] ?>', '<?= $class['email'] ?>', '<?= $class['subject'] ?>')">Edit</button> | 
                            <a href="online_class.php?delete_id=<?= $class['id'] ?>" onclick="return confirm('Are you sure you want to delete this class?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        <button class="add-teacher-btn" onclick="openAddModal()">Register New Student</button>

        <!-- Register New Student Modal -->
       <div id="addModal" class="modal">
            <div class="modal-content">
                <span class="close" onclick="closeAddModal()">&times;</span>
                <div class="modal-header">Register New Student</div>
                <form action="online_class.php" method="POST">
                <input type="text" name="name" placeholder="Student Name" required>
                <input type="email" name="email" placeholder="Email" required>
                <input type="text"  name="subject" placeholder="Subject" required>
                    <button type="submit" name="addClass">Add New Student</button>
        ...
        <!-- Modal for Edit Register Student -->
        <div id="editModal" class="modal">
            <div class="modal-content">
                <div class="modal-header">Edit Register Student</div>
                <form action="online_class.php" method="POST">
    ...
    <script>
        ...
        function openEditModal(id, name, email, subject) {
